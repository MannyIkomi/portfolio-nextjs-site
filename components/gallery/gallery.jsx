...
class Gallery extends Component {
  ...
  generatePreviews = (projects = [], Component) => {
    return projects.map(project => (
      <Component project={project} key={project.id} />
    ))
  }

  render() {
    return (
      <section className="gallery" id={this.type}>
        {this.generatePreviews(this.behanceApi.projects, ProjectPreview)}
      </section>
    )
  }
}
